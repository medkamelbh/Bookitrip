...
class _ReservationSearchWidgetState extends State<ReservationSearchWidget> {
  ...
  static final _categories = [
    CategoryItem(label: 'search.hotels', icon: Icons.hotel),
    CategoryItem(label: 'search.restaurants', icon: Icons.restaurant),
    // CategoryItem(label: 'Vols',       icon: Icons.flight),
    // CategoryItem(label: 'Évènements', icon: Icons.event),
    CategoryItem(label: 'search.transports', icon: Icons.directions_bus),
  ];
